...
## Acknowledgements
:blush: I.S. Jang provided the model CMDs using [Padova ischrone](http://stev.oapd.inaf.it/cgi-bin/cmd) and the observed CMDs of NGC 300 obtained by Hubble Space Telescope.  
:blush: H. Cho has always advised me how to improve the performance of the Python codes.
